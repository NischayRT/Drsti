"""
app.py — Drsti Python AI backend
--------------------------------------
Endpoints:
...
# Use AppData/Local/Drsti for persistent writable storage
def get_model_dir():
    if getattr(sys, 'frozen', False):
        # Running as PyInstaller bundle
        app_data = os.environ.get('LOCALAPPDATA', os.path.expanduser('~'))
        model_dir = os.path.join(app_data, 'Drsti', 'models')
    else:
...
if __name__ == "__main__":
    print("Drsti AI backend starting on http://localhost:5000")
